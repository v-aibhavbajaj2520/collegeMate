    ...
    <div className="space-y-4 sm:space-y-6 max-w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-gray-600 mt-1 text-sm sm:text-base">Manage your mentor sessions and bookings</p>
        </div>
        <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors w-full sm:w-auto">
          Book New Session
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4 md:gap-6">
        <motion.div
          ...
          className="bg-white p-2 sm:p-4 md:p-6 rounded-lg shadow-sm border border-gray-200"
        >
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {bookings.map((booking) => (
                <motion.tr
                  ...
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 0.1 * booking.id }}
                ...
                >
                  ...
                  <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-xs sm:text-sm text-gray-500">{booking.time}</div>
                  </td>
                  <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
