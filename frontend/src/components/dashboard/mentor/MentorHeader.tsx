...
const MentorHeader: React.FC<MentorHeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between px-8 py-6">
        {/* Left Zone - Mentor Welcome Message */}
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-base">
              Guide your students and grow your teaching practice.
            </p>
          </div>
        </div>

        {/* Right Zone - Mentor Actions */}
        <div className="flex items-center space-x-6">
          ...
          <div className="relative">
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-teal-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg group-hover:scale-105 transition-transform">
