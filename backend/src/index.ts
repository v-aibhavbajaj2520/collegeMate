...
// Send OTP email
const sendOTPEmail = async (email: string, otp: string, name: string): Promise<EmailResult> => {
  try {
...
const sendPasswordResetEmail = async (email: string, resetLink: string, name: string): Promise<EmailResult> => {
  try {
    const transporter = createTransporter();
